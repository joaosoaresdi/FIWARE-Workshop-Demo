...
class AirqualitySensor {
	...
	async registerSensor(service) {
		...
		console.log(data); 
		var ret = await broker.registerContext(this.sensor_id, this.sensor_type, data, service);
		return ret;
	}
	...
	async updateSensor(temperature, humidity, pressure, co2, service) {
		...
		var ret = await broker.updateContext(this.sensor_id, data, service);
		return ret;
	}
}
